...
describe('SQLite runtime integration', () => {
  it('creates a configured file-backed database and manages health safely', async () => {
    ...
    try {
      ...
      expect(connection.pragma('user_version', { simple: true })).toBe(26)
      expect(
      ...
      expect(logger.info.mock.calls.flat()).toEqual([
        ...
        'Database migration started; version=22; name=food-otc-sync',
        'Database migration applied; version=22; name=food-otc-sync',
        'Database migration started; version=23; name=clinical-screening-time',
        'Database migration applied; version=23; name=clinical-screening-time',
        'Database migration started; version=24; name=referral-sync',
        'Database migration applied; version=24; name=referral-sync',
        'Database migration started; version=25; name=encounter-history-sync',
        'Database migration applied; version=25; name=encounter-history-sync',
        'Database migration started; version=26; name=central-patient-history',
        'Database migration applied; version=26; name=central-patient-history',
        'Database migrations current; schemaVersion=26',
