...
describe('application shell rendering', () => {
  it('renders the dashboard hierarchy without operational sample data', () => {
    ...
    expect(displayMarkup).not.toContain('Loading local dashboard data...')
    expect(displayMarkup).not.toContain('Showing local patients.')
    expect(displayMarkup).not.toContain('Referral, sync, and backup summaries')
