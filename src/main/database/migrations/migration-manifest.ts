...
import clinicalTimeSql from './sql/0023-clinical-screening-time.sql?raw'

export const targetSchemaVersion = 23
...
const encounterManagementMigration = Object.freeze({
  version: 15,
...
const bpScreeningProtocolMigration = Object.freeze({
  version: 17,
  name: 'bp-screening-protocol',
...
const syncTransportFoundationMigration = Object.freeze({
  version: 19,
  name: 'sync-transport-foundation',
...
const syncIdentityResolutionDeliveryMigration = Object.freeze({
  version: 21,
  name: 'sync-identity-resolution-delivery',
  sql: syncIdentityResolutionDeliverySql
} satisfies DatabaseMigration)
...
export const databaseMigrations = Object.freeze([
  ...
  { version: 23, name: 'clinical-screening-time', sql: clinicalTimeSql } satisfies DatabaseMigration
] as const)
